...
import com.sx.manager.service.ProductService;
...
public class ProductController {
    ...
    public Product addProtduct(@RequestBody Product product){
    ...
    public Page<Product> query(String ids, BigDecimal minRewardRate, BigDecimal maxRewardRate, String status,@RequestParam(defaultValue = "0") int pageNum, int pageSize){
